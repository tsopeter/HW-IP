...
set Vendor      "ku"
set Library     "math"
set IPName      "vector_add"
set Version     "1.1"
set DisplayName "Vector_add"
set Revision    "0"
...
set xo_kernel_name "vector_add"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/tsope/OneDrive/Documents/GitHub/HW-IP/vector_add/solution2"
set debug_dir "C:/Users/tsope/OneDrive/Documents/GitHub/HW-IP/vector_add/solution2/.debug"
set xo_hls_files_dir ""
set hdl_module_list {vector_add_mul_8s_8s_8_1_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 y R 0x0 "Data signal of y" {{0 8 y R 0 "Bit 7 to 0 of y"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x14 y_ctrl R 0x0 "Control signal of y" {{0 1 y_ap_vld R 0 "Control signal y_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"

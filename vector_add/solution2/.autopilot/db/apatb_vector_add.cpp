...
// wrapc file define:
#define AUTOTB_TVIN_x "../tv/cdatafile/c.vector_add.autotvin_x.dat"
#define WRAPC_STREAM_SIZE_IN_x "../tv/stream_size/stream_size_in_x.dat"
#define WRAPC_STREAM_INGRESS_STATUS_x "../tv/stream_size/stream_ingress_status_x.dat"
#define AUTOTB_TVIN_w "../tv/cdatafile/c.vector_add.autotvin_w.dat"
#define WRAPC_STREAM_SIZE_IN_w "../tv/stream_size/stream_size_in_w.dat"
#define WRAPC_STREAM_INGRESS_STATUS_w "../tv/stream_size/stream_ingress_status_w.dat"
#define AUTOTB_TVIN_y "../tv/cdatafile/c.vector_add.autotvin_y.dat"
#define AUTOTB_TVOUT_y "../tv/cdatafile/c.vector_add.autotvout_y.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_y "../tv/rtldatafile/rtl.vector_add.autotvout_y.dat"
...
extern "C"
void apatb_vector_add_hw(void* __xlx_apatb_param_x, void* __xlx_apatb_param_w, void* __xlx_apatb_param_y)
{
  static hls::sim::Stream<hls::sim::Byte<1>> port0 {
    .width = 8,
    .name = "x",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_x),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_x),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_x),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_x),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_x;
  ...
  static hls::sim::Stream<hls::sim::Byte<1>> port1 {
    ...
    .name = "w",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_w),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_w),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_w),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_w),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_w;
  ...
  try {
    ...
    vector_add_hw_stub_wrapper(__xlx_apatb_param_x, __xlx_apatb_param_w, __xlx_apatb_param_y);

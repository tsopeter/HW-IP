...
HD_PWD='C:/Users/tsope/OneDrive/Documents/GitHub/HW-IP/vector_add/vadd/vadd.runs/design_1_vector_add_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_vector_add_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_vector_add_0_3.tcl

...
HD_PWD='C:/Users/tsope/OneDrive/Documents/GitHub/HW-IP/vector_add/vadd/vadd.runs/design_1_auto_us_df_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_auto_us_df_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_auto_us_df_2.tcl
